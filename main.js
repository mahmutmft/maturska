let cartIcon = document.querySelector("#cart-icona");
...
function addCartClicked(event) {
  ...
  var carImg = shopProducts.getElementsByClassName("carImg")[0].src;
...
function addProductToCart(title, price, carImg) {
  ...
  console.log(cartBoxContent); // should return a string with the correct values
